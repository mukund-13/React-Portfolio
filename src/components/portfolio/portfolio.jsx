...
const data = [
  ...
  },
  {
    ...
    description: "Developed a face recognition model using Machine Learning. The software would accept images as input, it would recognize them and display the name of the person near the face."
  },
  {
    id: 8,
    image: IMG8,
